...
var DxCheckBoxValueAccessorDirective = (function () {
    ...
    DxCheckBoxValueAccessorDirective.prototype.setDisabledState = function (isDisabled) {
    ...
    DxCheckBoxValueAccessorDirective.decorators = [
        { type: core_1.Directive, args: [{
                    selector: 'dx-check-box[formControlName],dx-check-box[formControl],dx-check-box[ngModel]',
                    providers: [CUSTOM_VALUE_ACCESSOR]
                },] },
    ];
    DxCheckBoxValueAccessorDirective.ctorParameters = function () { return [
        { type: DxCheckBoxComponent, },
    ]; };
    DxCheckBoxValueAccessorDirective.propDecorators = {
